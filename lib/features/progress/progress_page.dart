...
class _ProgressPageState extends State<ProgressPage> with WidgetsBindingObserver {
  ...
  Color _humeurColor(double val) {
    return switch (val.toInt()) {
      5 => const Color(0xFF1D9E75),
      4 => const Color(0xFF6DBF8A),
      3 => const Color(0xFFF4BC69),
      2 => const Color(0xFFE8845A),
      _ => const Color(0xFFD85A30),
    };
  }
    ...
    return AppScaffold(
      ...
      onTabSelected: (index) {
        switch (index) {
          ...
          case 1: _chargerNotes(); break;
          case 2: Navigator.pushReplacementNamed(context, '/calendar'); break;
          case 3: Navigator.pushReplacementNamed(context, '/videos'); break;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _PeriodeBtn(label: "1 sem.",  selected: _periode == Periode.semaine, onTap: () => setState(() => _periode = Periode.semaine)),
              ...
              Row(
                children: [
                  _StatCard(label: "Humeur moy.", value: moy > 0 ? moy.toStringAsFixed(1) : "—", color: theme.colorScheme.primary),
                  const SizedBox(width: 8),
                  _StatCard(label: "Meilleure",   value: _max > 0 ? _max.toStringAsFixed(0) : "—", color: Colors.green),
                  const SizedBox(width: 8),
                  _StatCard(label: "Plus basse",  value: _min > 0 ? _min.toStringAsFixed(0) : "—", color: Colors.orange),
                ],
              ),
              ...
              Row(
                children: [
                  Text("Évolution de l'humeur", style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const Spacer(),
                  IconButton(icon: const Icon(Icons.refresh, size: 20), onPressed: _chargerNotes, tooltip: "Actualiser"),
                ],
              ),
              Text(
                "Enregistre ton humeur depuis l'accueil pour alimenter ce graphique.",
                  ...
                  : SizedBox(
                      ...
                      child: BarChart(
                        BarChartData(
                            ...
                            bottomTitles: AxisTitles(
                              sideTitles: SideTitles(
                                ...
                                getTitlesWidget: (val, _) {
                                  ...
                                  return Text(_labelDate(notes[i].date), style: const TextStyle(fontSize: 10, color: Colors.grey));
                                },
                              ),
                            ),
                          ...
                          barGroups: notes.asMap().entries.map((e) => BarChartGroupData(
                            x: e.key,
              ...
              Wrap(
                ...
                runSpacing: 6,
                children: [
                  _LegendDot(color: const Color(0xFF1D9E75), label: "😄 Super (5)"),
                  _LegendDot(color: const Color(0xFF6DBF8A), label: "🙂 Bien (4)"),
                  _LegendDot(color: const Color(0xFFF4BC69), label: "😐 Neutre (3)"),
                  _LegendDot(color: const Color(0xFFE8845A), label: "😕 Pas top (2)"),
                  _LegendDot(color: const Color(0xFFD85A30), label: "😔 Mal (1)"),
                ],
              ),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          alignment: Alignment.center,
          child: Text(label, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: selected ? Colors.white : Colors.grey)),
        ),
      ),
    );
  }
